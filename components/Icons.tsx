...
export const LogoIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M20 4L4 12L20 20L36 12L20 4Z" fill="currentColor" fillOpacity="0.8"/>
    <path d="M4 12V28L20 36V20L4 12Z" fill="currentColor" fillOpacity="0.4"/>
    <path d="M36 12V28L20 36V20L36 12Z" fill="currentColor" fillOpacity="0.6"/>
  </svg>
);
...
export const MarketIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 3H5L6.68 14.39C6.76162 15.0253 7.07689 15.6031 7.56708 16.024C8.05727 16.4449 8.68884 16.6802 9.34 16.68H19.34C19.9806 16.6775 20.6015 16.4452 21.0872 16.0272C21.5728 15.6092 21.8906 15.034 21.98 14.4L23 6H6" />
...
export const ReverseIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const AlertIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const QRIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const WifiIcon: React.FC<IconProps & { signal?: 'good' | 'weak' | 'offline' }> = ({ size = 24, signal = 'good', ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M5 12.55a11 11 0 0 1 14.08 0" opacity={signal === 'offline' ? 0.2 : 1} />
    <path d="M1.42 9a16 16 0 0 1 21.16 0" opacity={signal === 'offline' || signal === 'weak' ? 0.2 : 1} />
...
export const HeartIcon: React.FC<IconProps & { filled?: boolean }> = ({ size = 24, filled = false, ...props }) => (
